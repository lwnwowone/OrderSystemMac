...
//  TimerComparison
//
//  Created by Alanc on 6/12/15.
//  Copyright (c) 2015 com.tencent. All rights reserved.
//

#import "ALTimerManager.h"

@interface ALTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation ALTimerManager

#pragma mark - Public Method

+ (ALTimerManager *)sharedInstance
{
    static ALTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[ALTimerManager alloc] init];
    });
    
    return _gcdTimerManager;
}

-(void)runTimerWithName:(NSString *)timerName
